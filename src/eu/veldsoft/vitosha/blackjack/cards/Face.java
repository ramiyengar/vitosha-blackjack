...
public class Face {
	...
	/**
	 * Conversion constructor that creates a Face object based on an Integer
	 * code.
	 *
	 * @param face
	 *            The Integer code that represents a face value.
	 */
	 ...
	 *
	 * @param name
	 *            The String representation of the face value.
	 */
	 ...
	 *
	 * @param value
	 *            The Integer value of the face value.
	 */
