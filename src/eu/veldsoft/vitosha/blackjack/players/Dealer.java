...
public class Dealer extends BlackjackPlayer {
	...
	/**
	 * Default constructor that creates a new dealer with a deck of 2 card
	 * packs.
	 */
	public Dealer() {
	 ...
	 *
	 * @param player
	 *            The player requesting another card.
	 */
	...
	/**
	 * Player would like to place a bet up to double of his original and have
	 * the dealer give him one more card.
	 *
	 * @param player
	 *            The player requesting to play double.
	 */
	 ...
	 *
	 * @param player
	 *            The player who wishes to stand.
	 */
	 ...
	 *
	 * @param player
	 *            The opposing player of the dealer.
	 */
